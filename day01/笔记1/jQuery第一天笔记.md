...
​		touchEvent：事件对象.touches，事件对象.targetTouches，事件对象.changedTouches

​		transitionend事件：过渡结束事件
...
​	jQuery：JavaScript库，封装了好多方法

​	下载，引入，书写

​	入口函数：$(function () {});

​	JQuery对象：DOM（获取方式），jQuery对象（$(XXX)）;DOM只能用DOM方法，JQuery只能用jQuery方法
...
​	jQuery选择器：parent，children，find，siblings，eq

​	隐式迭代：会自动遍历DOM对象，链式编程：对象.方法.方法

​	排他思想：siblings，获取索引值：index();
